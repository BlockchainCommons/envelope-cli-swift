...
ALICE_CID="ur:cid/hdcxtygshybkzcecfhflpfdlhdonotoentnydmzsidmkindlldjztdmoeyishknybtbswtgwwpdi"
...
ALICE_PUBKEYS="ur:crypto-pubkeys/lftaadfwhdcxrdhgfsfsfsosrloebgwmfrfhsnlskegsjydecawybniadyzovehncacnlbmdbesstaaddmhdcxytgefrmnbzftltcmcnaspaimhftbjehlatjklkhktidrpmjobslewkfretcaetbnrtlevawt"

BOB_CID="ur:cid/hdcxdkreprfslewefgdwhtfnaosfgajpehhyrlcyjzheurrtamfsvolnaxwkioplgansesiabtdr"
...
CAROL_CID="ur:cid/hdcxamstktdsdlplurgaoxfxdijyjysertlpehwstkwkskmnnsqdpfgwlbsertvatbbtcaryrdta"
...
LEDGER_CID="ur:cid/hdcxbatnhhvdnydnhfcfvlltwkmhlncydmjpbygomhdtqdqdintkmkzojyndterdnyhlvdnbenft"
...
LEDGER_PUBKEYS="ur:crypto-pubkeys/lftaadfwhdcxmdoyskbbkshtkbgdmtqdmwtadiecmysksrfyoegdcfhnrkctrehfemwdtswdmugstaaddmhdcxssdwgwtipdgazmaeftgeaddaiyectikbjebtckfzsbzoqdolrhwfwmihprgdecdtaxzecfiy"

STATE_CID="ur:cid/hdcxaaenfsheytmseorfbsbzktrdrdfybkwntkeegetaveghzstattdertbswsihahvspllbghcp"
...
STATE_PUBKEYS="ur:crypto-pubkeys/lftaadfwhdcxsegystjeisrshnyattgsswclpdmnsfzsgwcphgskdyuyahhecfrlhyvddsonbbsataaddmhdcxrfretiztzsoectchdsdizslpwyticsleonoxwliywfvsmhclrdplcplsfrnnptisimprvytd"
```
...
```
👈
ur:envelope/lftpsptpcsiyfdihjzjzjldmtpsptpsolftpsptpsgaxtpsptpcstaadfzhdfzhegmehhtjeeodlmhmekblsgrzoylglhssakshfskhghkmypkwturpmtyurlrdkztndjkytvaaojzjpdwrfsfurbyrnlrbavywttlwdtdskynnddygsaheelplyylisgdhljlfwsa
```
...
```
👈
ur:
```
...
```
👈
ur:crypto-key/hdcxkkmnrnwljzytfdnbgwbdfrdrwkendeswtntidibnpezerhaxnsfsdrbeoeinwmleenurrdrp
```
...
```
👈
ur:envelope/tpsnlrgaoeglghvlotnysghesogsesvskbhshtiamuhpfhoytlytgdaartpfuyatemfhmyynswrovwgalsfehkhddktpsfhdcxlksojzuyktbykovsecbygebsldeninbdfptkwebtwzdpadglwetbgltnwdmwhlhkynbwimge
```
...
```
👈
ur:crypto-key/hdcxaxwesfgaknfzzelksgosmkkkadktgybainbdmhwdasmnfrdlbbjlvaosledsvefhtppfwthg
```
...
```
👈
ur:
```
...
```
👈
ur:crypto-key/hdcxplhgatdawncpentpgovwoxflzcmtgagyrdatfnrygendqzgsbsvtfzwtndcminnseepasaax
```
...
```
👈
ur:
```
...
```
👈
ur:
```
...
```
👈
ur:
```
